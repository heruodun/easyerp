  ...
  var addElementTypes = function (context) {
    ...
    context.addPrintElementTypes('taskProviderModule', [
      new hiprint.PrintElementTypeGroup('平台', [
        ...
        {
          tid: 'taskProviderModule.platform',
          title: '平台名称',
          data: '平台名称',
          type: 'text',
          options: {
      ...
      new hiprint.PrintElementTypeGroup('库管', [
        {
          tid: 'taskProviderModule.creater',
          title: '制单人',
          data: '李四',
          type: 'text',
          options: {
        ...
        {
          tid: 'taskProviderModule.printDate',
          title: '打印时间',
