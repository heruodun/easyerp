...
export const panelsProvider1 = function (ops) {
  var addElementTypes = function (context) {
    ...
    context.addPrintElementTypes('panelsProvider1', [
      new hiprint.PrintElementTypeGroup('平台', [
        {
          tid: 'panelsProvider1.header',
          title: '单据表头',
          data: '单据表头',
          type: 'text',
          options: {
...
export const panelsProvider2 = function (ops) {
  var addElementTypes = function (context) {
    ...
    context.addPrintElementTypes('panelsProvider2', [
      new hiprint.PrintElementTypeGroup('常规', [
        {
          tid: 'panelsProvider2.header',
          title: '单据表头',
          data: '单据表头',
          type: 'text',
          options: {
